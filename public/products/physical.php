  ...
  <main id="main-content" class="flex-1 flex flex-col min-w-0 overflow-y-auto">
    ...
    <div class="p-6 sm:p-8 max-w-5xl space-y-6">
      <div class="bg-white rounded-2xl border border-slate-200 shadow-xs p-6">
        <h2 class="text-sm font-bold text-slate-900 uppercase tracking-wide mb-4">Physical Stock</h2>
        <p class="text-slate-600 text-sm">Physical stock content coming soon...</p>
      </div>
    </div>
  </main>
