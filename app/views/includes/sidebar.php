...
<!-- <?php 
  $isCollapsed = ($_COOKIE['feedmill_sidebar_collapsed'] ?? 'false') === 'true';
  $sidebarWidthClass = $isCollapsed ? 'md:w-20 collapsed' : 'md:w-72';
?> -->
...
<aside id="sidebar" class="group/sidebar w-full md:w-72 bg-slate-900 text-slate-300 flex flex-col justify-between shrink-0 h-screen border-r border-slate-800 transition-all duration-300 relative z-20">
  <div class="flex-1 flex flex-col min-h-0">
    ...
    <nav id="sidebar-navigation" class="p-4 space-y-6 text-xs font-medium overflow-y-auto flex-1 group-[.collapsed]/sidebar:md:overflow-visible group-[.collapsed]/sidebar:md:p-2 group-[.collapsed]/sidebar:md:space-y-4">
      ...
      <div class="relative group/menu">
        <button type="button" class="w-full px-3 py-1 mb-2 text-left text-[10px] font-bold text-slate-500 uppercase tracking-widest flex gap-3 items-center rounded-lg hover:bg-slate-800/50 group-[.collapsed]/sidebar:md:mb-0 group-[.collapsed]/sidebar:md:justify-center group-[.collapsed]/sidebar:md:p-2" aria-expanded="<?php echo in_array($current_page, $productPages, true) ? 'true' : 'false'; ?>" aria-controls="product-menu" onclick="toggleMenu(this, 'product-menu')">
      ...
      <!-- SECTION 3: Inventory -->
      <div class="relative group/menu">
        <button type="button" class="w-full px-3 py-1 mb-2 text-left text-[10px] font-bold text-slate-500 uppercase tracking-widest flex gap-3 items-center rounded-lg hover:bg-slate-800/50 group-[.collapsed]/sidebar:md:mb-0 group-[.collapsed]/sidebar:md:justify-center group-[.collapsed]/sidebar:md:p-2" aria-expanded="<?php echo in_array($current_page, $inventoryPages, true) ? 'true' : 'false'; ?>" aria-controls="inventory-menu" onclick="toggleMenu(this, 'inventory-menu')">
      ...
      <!-- SECTION 4: Reports -->
      <div class="relative group/menu">
        <button type="button" class="w-full px-3 py-1 mb-2 text-left text-[10px] font-bold text-slate-500 uppercase tracking-widest flex gap-3 items-center rounded-lg hover:bg-slate-800/50 group-[.collapsed]/sidebar:md:mb-0 group-[.collapsed]/sidebar:md:justify-center group-[.collapsed]/sidebar:md:p-2" aria-expanded="<?php echo in_array($current_page, $reportPages, true) ? 'true' : 'false'; ?>" aria-controls="reports-menu" onclick="toggleMenu(this, 'reports-menu')">
      ...
      <div class="relative group/menu">
        <button type="button" class="w-full px-3 py-1 mb-2 text-left text-[10px] font-bold text-slate-500 uppercase tracking-widest flex gap-3 items-center rounded-lg hover:bg-slate-800/50 group-[.collapsed]/sidebar:md:mb-0 group-[.collapsed]/sidebar:md:justify-center group-[.collapsed]/sidebar:md:p-2" aria-expanded="<?php echo in_array($current_page, $administrationPages, true) ? 'true' : 'false'; ?>" aria-controls="administration-menu" onclick="toggleMenu(this, 'administration-menu')">
        ...
        <div id="administration-menu" class="space-y-1 group-[.collapsed]/sidebar:md:absolute group-[.collapsed]/sidebar:md:left-full group-[.collapsed]/sidebar:md:top-0 group-[.collapsed]/sidebar:md:ml-3 group-[.collapsed]/sidebar:md:w-56 group-[.collapsed]/sidebar:md:bg-slate-900 group-[.collapsed]/sidebar:md:border group-[.collapsed]/sidebar:md:border-slate-800 group-[.collapsed]/sidebar:md:rounded-xl group-[.collapsed]/sidebar:md:p-2 group-[.collapsed]/sidebar:md:shadow-2xl" <?php echo in_array($current_page, $administrationPages, true) ? '' : 'hidden'; ?>>
          <a href="<?php echo htmlspecialchars(publicUrl('admin/millers.php')); ?>" hx-get="mixing.php" 
   hx-target="#main-content" 
   hx-select="#main-content" 
   hx-push-url="true" class="<?php echo sidebarLinkClass('admin/millers.php', $current_page); ?>">Millers</a>
          
          <?php if($isAdmin): ?>
          <a href="<?php echo htmlspecialchars(publicUrl('admin/accounts.php')); ?>" hx-get="mixing.php" 
   hx-target="#main-content" 
   hx-select="#main-content" 
   hx-push-url="true" class="<?php echo sidebarLinkClass('admin/accounts.php', $current_page); ?>">User Accounts</a>
          <a href="<?php echo htmlspecialchars(publicUrl('admin/audit.php')); ?>" hx-get="mixing.php" 
   hx-target="#main-content" 
   hx-select="#main-content" 
   hx-push-url="true" class="<?php echo sidebarLinkClass('admin/audit.php', $current_page); ?>">Audit Logs</a>
          <?php endif; ?>
        </div>
      </div>
...
<script src="<?php echo htmlspecialchars(publicUrl('js/nav.js')); ?>"></script>