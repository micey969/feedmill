...
<aside id="sidebar" class="group/sidebar w-full md:w-72 bg-slate-900 text-slate-300 flex flex-col justify-between shrink-0 h-screen border-r border-slate-800 transition-all duration-300 relative z-20">
  <div class="flex-1 flex flex-col min-h-0">
    ...
    <!-- Navigation Links -->
    <nav id="sidebar-navigation" hx-boost="true" hx-target="#main-content" hx-select="#main-content" class="p-4 space-y-6 text-xs font-medium overflow-y-auto flex-1 group-[.collapsed]/sidebar:md:overflow-visible group-[.collapsed]/sidebar:md:p-2 group-[.collapsed]/sidebar:md:space-y-4">
